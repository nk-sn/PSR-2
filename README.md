...
Тело каждой конструкции ОБЯЗАНО быть замкнуто фигурными скобками. Это стандартизирут вид конструкций, и уменьшает вероятность введения ошибок таких как добавление новых строк в тело конструкции.
